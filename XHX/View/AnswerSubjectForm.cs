...
/// <returns></returns>
        ...
        private void btnPictureUpload_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (uploaddto.FilePath.Contains(':') && uploaddto.FilePath.Contains('\\'))
            {
                ...
                aliyun.PutObject("yrtech", "LEXUS" + @"/" + CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text + @"/" + SubjectCode_Golbal + @"/" + uploaddto.FileName + ".jpg", filePath);
        ...
        private void grcLoss_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (bdhi.InRow)
            {
                ...
                for (int i = 0; i < filenameList.Length; i++)
                {
                    ...
                    aliyun.PutObject("yrtech", "LEXUS" + @"/" + CommonHandler.GetComboBoxSelectedValue(cboProjects).ToString() + txtShopName.Text + @"/" + SubjectCode_Golbal + @"/" + filenameList[i] + ".jpg", filePath);
